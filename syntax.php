...

{
    ...
    {
        $this->Lexer->addSpecialPattern('<eqmap.*?>.*?</eqmap>', $mode, 'plugin_eqmap');
    }
    ...
    // Default values if handle() failed to find attributes
    $defaults = [
        'centered' => false, 'centerLat' => null, 'centerLon' => null,
        'zoom' => 2, 'pois' => [], 'info' => '', 'debug' => false
    ];
